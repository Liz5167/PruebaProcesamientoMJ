###########################################################################
## Makefile generated for component 'ProcesamientoImagen'. 
## 
## Makefile     : ProcesamientoImagen_rtw.mk
## Generated on : Thu Jan 25 22:16:48 2024
## Final product: ./ProcesamientoImagen.a
...
PRODUCT_NAME              = ProcesamientoImagen
MAKEFILE                  = ProcesamientoImagen_rtw.mk
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/Lizeth/OneDrive_-_Instituto_Politecnico_Nacional/MATLAB
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = ProcesamientoImagen.a
...
DEFINES_STANDARD = -DMODEL=ProcesamientoImagen
...
SRCS = $(START_DIR)/codegen/lib/ProcesamientoImagen/ProcesamientoImagen_initialize.cpp $(START_DIR)/codegen/lib/ProcesamientoImagen/ProcesamientoImagen_terminate.cpp $(START_DIR)/codegen/lib/ProcesamientoImagen/ProcesamientoImagen.cpp $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2023a/toolbox/target/supportpackages/nvidia/sources/utils/MW_nvidia_init.c
...
OBJS = ProcesamientoImagen_initialize.cpp.o ProcesamientoImagen_terminate.cpp.o ProcesamientoImagen.cpp.o MW_nvidia_init.c.o
...
%.c.o : $(START_DIR)/codegen/lib/ProcesamientoImagen/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/codegen/lib/ProcesamientoImagen/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/codegen/lib/ProcesamientoImagen/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ProcesamientoImagen_initialize.cpp.o : $(START_DIR)/codegen/lib/ProcesamientoImagen/ProcesamientoImagen_initialize.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ProcesamientoImagen_terminate.cpp.o : $(START_DIR)/codegen/lib/ProcesamientoImagen/ProcesamientoImagen_terminate.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ProcesamientoImagen.cpp.o : $(START_DIR)/codegen/lib/ProcesamientoImagen/ProcesamientoImagen.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
